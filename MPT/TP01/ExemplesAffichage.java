...
public class ExemplesAffichage {
	...
	public static void main(String[] args) {
		...
		String e1ipostfixe = expression1().accepter(postfixe);
		System.out.println("e1 = " + e1ipostfixe);

		// Afficher expression2
		String e2ipostfixe = expression2().accepter(postfixe);
		System.out.println("e2 = " + e2ipostfixe);
	}
}
