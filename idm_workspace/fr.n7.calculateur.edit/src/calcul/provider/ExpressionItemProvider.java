		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CalculPackage.Literals.EXPRESSION__NAME,
				 true,
				 false,
				 false,
	...
	protected void addValeurPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Expression_valeur_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Expression_valeur_feature", "_UI_Expression_type"),
				 CalculPackage.Literals.EXPRESSION__VALEUR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLinkToPredecessorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Expression_linkToPredecessor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Expression_linkToPredecessor_feature", "_UI_Expression_type"),
				 CalculPackage.Literals.EXPRESSION__LINK_TO_PREDECESSOR,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addLinkToSuccessorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Expression_linkToSuccessor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Expression_linkToSuccessor_feature", "_UI_Expression_type"),
				 CalculPackage.Literals.EXPRESSION__LINK_TO_SUCCESSOR,
				 true,
				 false,
				 true,
				 null,
