...
public class BinaireItemProvider extends ExpressionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Binaire_binaryType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Binaire_binaryType_feature", "_UI_Binaire_type"),
				 CalculPackage.Literals.BINAIRE__BINARY_TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Binaire)object).getName();
