...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 */
	@Override
	public EAttribute getStock_Quantite() {
	 ...
	 */
	@Override
	public EReference getStock_Ressource() {
	 ...
	 */
	@Override
	public EAttribute getRessource_Occurrences() {
	 ...
	 */
	@Override
	public EReference getRessource_Stock() {
	 ...
	 */
	@Override
	public EReference getRessource_WorkDefinition() {
	...
	public void createPackageContents() {
		...
		createEAttribute(stockEClass, STOCK__QUANTITE);
		createEAttribute(stockEClass, STOCK__NAME);
		createEReference(stockEClass, STOCK__RESSOURCE);

		ressourceEClass = createEClass(RESSOURCE);
		createEAttribute(ressourceEClass, RESSOURCE__OCCURRENCES);
		createEReference(ressourceEClass, RESSOURCE__STOCK);
		createEReference(ressourceEClass, RESSOURCE__WORK_DEFINITION);
	...
	public void initializePackageContents() {
		...
		stockEClass.getESuperTypes().add(this.getProcessElement());
		...
		initEReference(getWorkDefinition_Ressource(), this.getRessource(), this.getRessource_WorkDefinition(), "ressource", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getStock_Quantite(), ecorePackage.getEIntegerObject(), "quantite", null, 1, 1, Stock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getStock_Name(), ecorePackage.getEString(), "name", null, 1, 1, Stock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStock_Ressource(), this.getRessource(), this.getRessource_Stock(), "ressource", null, 1, -1, Stock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(ressourceEClass, Ressource.class, "Ressource", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getRessource_Occurrences(), ecorePackage.getEIntegerObject(), "occurrences", null, 1, 1, Ressource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRessource_Stock(), this.getStock(), this.getStock_Ressource(), "stock", null, 1, 1, Ressource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRessource_WorkDefinition(), this.getWorkDefinition(), this.getWorkDefinition_Ressource(), "workDefinition", null, 1, 1, Ressource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
