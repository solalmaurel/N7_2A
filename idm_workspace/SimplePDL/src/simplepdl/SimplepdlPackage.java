...
public interface SimplepdlPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link simplepdl.impl.StockImpl <em>Stock</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see simplepdl.impl.StockImpl
	 * @see simplepdl.impl.SimplepdlPackageImpl#getStock()
	 * @generated
	 */
	int STOCK = 5;
	 ...
	 * @ordered
	 */
	int STOCK__PROCESS = PROCESS_ELEMENT__PROCESS;
	 ...
	 * @ordered
	 */
	int STOCK__QUANTITE = PROCESS_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int STOCK__NAME = PROCESS_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int STOCK__RESSOURCE = PROCESS_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int STOCK_FEATURE_COUNT = PROCESS_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int STOCK_OPERATION_COUNT = PROCESS_ELEMENT_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RESSOURCE__OCCURRENCES = PROCESS_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RESSOURCE__WORK_DEFINITION = PROCESS_ELEMENT_FEATURE_COUNT + 2;
	...
	/**
	 * Returns the meta object for the reference list '{@link simplepdl.WorkDefinition#getRessource <em>Ressource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link simplepdl.Stock <em>Stock</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link simplepdl.Stock#getQuantite <em>Quantite</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Quantite</em>'.
	 * @see simplepdl.Stock#getQuantite()
	 * @see #getStock()
	 * @generated
	 */
	EAttribute getStock_Quantite();

	/**
	 * Returns the meta object for the attribute '{@link simplepdl.Stock#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see simplepdl.Stock#getName()
	 * @see #getStock()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference list '{@link simplepdl.Stock#getRessource <em>Ressource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Ressource</em>'.
	...
	/**
	 * Returns the meta object for the attribute '{@link simplepdl.Ressource#getOccurrences <em>Occurrences</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Occurrences</em>'.
	 * @see simplepdl.Ressource#getOccurrences()
	 * @see #getRessource()
	 * @generated
	 */
	EAttribute getRessource_Occurrences();

	/**
	 * Returns the meta object for the reference '{@link simplepdl.Ressource#getStock <em>Stock</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EReference getRessource_Stock();

	/**
	 * Returns the meta object for the reference '{@link simplepdl.Ressource#getWorkDefinition <em>Work Definition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Work Definition</em>'.
	 * @see simplepdl.Ressource#getWorkDefinition()
	 * @see #getRessource()
	 * @generated
	 */
	EReference getRessource_WorkDefinition();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link simplepdl.impl.StockImpl <em>Stock</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see simplepdl.impl.StockImpl
		 * @see simplepdl.impl.SimplepdlPackageImpl#getStock()
		 ...
		 * @generated
		 */
		EAttribute STOCK__QUANTITE = eINSTANCE.getStock_Quantite();
		 ...
		 * @generated
		 */
		EReference STOCK__RESSOURCE = eINSTANCE.getStock_Ressource();
		 ...
		 * @generated
		 */
		EAttribute RESSOURCE__OCCURRENCES = eINSTANCE.getRessource_Occurrences();
		 ...
		 * @generated
		 */
		EReference RESSOURCE__STOCK = eINSTANCE.getRessource_Stock();
		 ...
		 * @generated
		 */
		EReference RESSOURCE__WORK_DEFINITION = eINSTANCE.getRessource_WorkDefinition();
