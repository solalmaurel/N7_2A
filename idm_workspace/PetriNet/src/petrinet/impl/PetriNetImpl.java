 ...
 *   <li>{@link petrinet.impl.PetriNetImpl#getNoeuds <em>Noeuds</em>}</li>
...
public class PetriNetImpl extends MinimalEObjectImpl.Container implements PetriNet {
	...
	public EList<Noeud> getNoeuds() {
		if (noeuds == null) {
			noeuds = new EObjectContainmentWithInverseEList<Noeud>(Noeud.class, this, PetrinetPackage.PETRI_NET__NOEUDS, PetrinetPackage.NOEUD__PETRINET);
		}
		return noeuds;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PetrinetPackage.PETRI_NET__NOEUDS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getNoeuds()).basicAdd(otherEnd, msgs);
