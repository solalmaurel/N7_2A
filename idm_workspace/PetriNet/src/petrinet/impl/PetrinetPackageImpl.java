...
public class PetrinetPackageImpl extends EPackageImpl implements PetrinetPackage {
	 ...
	 */
	@Override
	public EReference getNoeud_Depart() {
	 ...
	 */
	@Override
	public EReference getNoeud_Arrivee() {
	 ...
	 */
	@Override
	public EReference getNoeud_Petrinet() {
	 ...
	 */
	@Override
	public EReference getArc_Cible() {
	 ...
	 */
	@Override
	public EAttribute getArc_Lecteur() {
	 ...
	 */
	@Override
	public EAttribute getPlace_Poids() {
	...
	public void createPackageContents() {
		...
		createEReference(noeudEClass, NOEUD__DEPART);
		createEReference(noeudEClass, NOEUD__ARRIVEE);
		createEReference(noeudEClass, NOEUD__PETRINET);

		arcEClass = createEClass(ARC);
		createEAttribute(arcEClass, ARC__POIDS);
		createEReference(arcEClass, ARC__SOURCE);
		createEReference(arcEClass, ARC__CIBLE);
		createEAttribute(arcEClass, ARC__NAME);
		createEAttribute(arcEClass, ARC__LECTEUR);
		createEReference(arcEClass, ARC__PETRINET);

		placeEClass = createEClass(PLACE);
		createEAttribute(placeEClass, PLACE__POIDS);
	...
	public void initializePackageContents() {
		...
		initEReference(getPetriNet_Noeuds(), this.getNoeud(), this.getNoeud_Petrinet(), "noeuds", null, 0, -1, PetriNet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getNoeud_Depart(), this.getArc(), this.getArc_Source(), "depart", null, 0, -1, Noeud.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNoeud_Arrivee(), this.getArc(), this.getArc_Cible(), "arrivee", null, 0, -1, Noeud.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNoeud_Petrinet(), this.getPetriNet(), this.getPetriNet_Noeuds(), "petrinet", null, 1, 1, Noeud.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(arcEClass, Arc.class, "Arc", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getArc_Poids(), ecorePackage.getEIntegerObject(), "poids", null, 1, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArc_Source(), this.getNoeud(), this.getNoeud_Depart(), "source", null, 1, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArc_Cible(), this.getNoeud(), this.getNoeud_Arrivee(), "cible", null, 1, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getArc_Lecteur(), ecorePackage.getEBooleanObject(), "lecteur", "false", 0, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPlace_Poids(), ecorePackage.getEIntegerObject(), "poids", null, 1, 1, Place.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
