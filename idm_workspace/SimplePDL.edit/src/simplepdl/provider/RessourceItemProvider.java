...
public class RessourceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_occurrences_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_occurrences_feature", "_UI_Ressource_type"),
				 SimplepdlPackage.Literals.RESSOURCE__OCCURRENCES,
				 true,
				 false,
				 false,
	...
	protected void addWorkDefinitionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_workDefinition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_workDefinition_feature", "_UI_Ressource_type"),
				 SimplepdlPackage.Literals.RESSOURCE__WORK_DEFINITION,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		Integer labelValue = ((Ressource)object).getOccurrences();
