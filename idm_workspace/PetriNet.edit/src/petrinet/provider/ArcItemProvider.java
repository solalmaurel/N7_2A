...
public class ArcItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addLecteurPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Lecteur feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addLecteurPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Arc_lecteur_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Arc_lecteur_feature", "_UI_Arc_type"),
				 PetrinetPackage.Literals.ARC__LECTEUR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
