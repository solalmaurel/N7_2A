	...
	protected void addDepartPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Noeud_depart_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Noeud_depart_feature", "_UI_Noeud_type"),
				 PetrinetPackage.Literals.NOEUD__DEPART,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addArriveePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Noeud_arrivee_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Noeud_arrivee_feature", "_UI_Noeud_type"),
				 PetrinetPackage.Literals.NOEUD__ARRIVEE,
				 true,
				 false,
				 true,
				 null,
