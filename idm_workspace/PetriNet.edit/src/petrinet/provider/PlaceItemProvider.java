...
public class PlaceItemProvider extends NoeudItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Place_poids_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Place_poids_feature", "_UI_Place_type"),
				 PetrinetPackage.Literals.PLACE__POIDS,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Place.class)) {
			case PetrinetPackage.PLACE__POIDS:
